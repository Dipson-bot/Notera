...
<body>
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['btn_img'])) {
            ...
            if ($fileExtension !== "pdf") {
                ...
                if ($imageInfo === false) {
                    ...
                    $sql = "INSERT INTO pending_books (id, user_id, pdf, book_cover, book_name, author_name, published_date, cat_id, subcat_id, uploaded_by) 
                            VALUES ('$newId', '$user_id', '$filename', '$bookCover', '$bookName', '$authorName', '$publishedDate', '$category_id', '$subcat_id', '$user_id')";
    ...
    <div class="modal fade" id="copyrightModal" tabindex="-1" aria-labelledby="copyrightModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <p>This agreement governs your use of our note management system. By using our platform, you agree to
                        the following terms:</p><br>
                    <ul>
                        ...
                        <li>We respect intellectual property rights and will respond to valid copyright infringement
                            claims.</li><br>
                    </ul>
                </div>
