                                        ...
                                        <div class="section text-center">
                                            ...
                                            if (isset($_POST['register'])) {
                                                ...
                                                if (!preg_match("/^[a-zA-Z ]{3,}$/", $name)) {
                                                    ...
                                                    echo '<script type="text/javascript">alert("Passwords do not match. Please confirm your password.")</script>';
                                                    ...
                                                    $query = "INSERT INTO users (name, email, password, mobile, address, role) VALUES ('$name', '$email', '$hashed_password', '$mobile', '$_POST[address]', 'user')";
